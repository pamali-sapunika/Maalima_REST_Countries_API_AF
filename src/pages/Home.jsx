import { Container, Box, Text, SimpleGrid, Image, Spinner } from "@chakra-ui/react";
import { useState, useEffect } from "react";
import { getAllCountries, searchCountryByName, filterByRegion } from "../services/api";
    ...
    <Container maxW="container.xl" py={8}>
        ...
        {loading ? (
            ...
            {countries.map((country) => (
                ...
                <Text>
                    <b>Languages:</b> {country.languages ? Object.values(country.languages).join(", ") : "N/A"}
                </Text>
                </Box>
            ))}
            </SimpleGrid>
